...
| `E039` | Template expansion error. Triggered by a malformed `(template (<name> <param>...) <body>)` declaration, a template use with the wrong number of arguments, or a recursive template expansion cycle. |
