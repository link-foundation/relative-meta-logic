...
| [`meta-theory-network.mjs`](./meta-theory-network.mjs) | Explicit K0 report, replaceable set foundations, checked cross-theory chains, graph/relation operations, and a bounded cyclic sequence |
