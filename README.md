...
between two tested transition functions. A separate v13 experiment starts from
...
classification theorem. A v10 structural probe also keeps mathematical
...
structure. The v10 authority follow-up adds one ordinary incidence link to two
